...
class Antpath extends Component {
    constructor(props) {
        super(props);
        this.state = {
            lineToanimate:L.polyline([[27,88],[28,87],[29,87]], { snakingSpeed:  this.props.speed,color:this.props.pathColor }),
    ...
    componentDidUpdate(prevProps, prevState) {
        ...
        !this.props.withMarker?this.state.lineToanimate=L.polyline([[27,88],[28,87],[29,87]], { snakingSpeed: this.props.speed,color:this.props.pathColor }):this.state.lineToanimate=L.layerGroup([
            L.circleMarker([27,88]).bindTooltip("Airport",{permanent:true,}),
            L.polyline([[27,88], [28,87]],{ snakingSpeed: this.props.speed,color:this.props.pathColor }),
            L.circleMarker([28,87]).bindTooltip("Hotel",{permanent:true,}),
            L.polyline([[28,87], [29,87]],{ snakingSpeed: this.props.speed,color:this.props.pathColor }),
            L.circleMarker([29,87]).bindTooltip("Conference Hall",{permanent:true,}),
